...
export const fetchViews = () => dispatch =>
  ViewApiUtil.getViews().then(views => dispatch(receiveGeoJSON(views.data)));

export const fetchView = id => dispatch =>
  ViewApiUtil.getView(id).then(view =>
    dispatch(receiveFullViewData(view.data))
  );

export const createView = viewData => dispatch =>
  ViewApiUtil.createView(viewData).then(view =>
    dispatch(receiveFullViewData(view.data))
  );
